...
function NativeSelectOption({
  ...
  return (
    <option
      ...
      className={cn("bg-white text-zinc-900 dark:bg-zinc-900 dark:text-zinc-100", className)}
      {...props}
    />
  )
}
